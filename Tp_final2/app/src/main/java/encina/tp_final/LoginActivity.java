package encina.tp_final;

import android.content.Intent;
import android.database.Cursor;
import android.support.v7.app.AppCompatActivity;             //Libreria de donde se extiende la clase para activity
import android.os.Bundle;                                    //Libreria para referenciar el layout con la clase
import android.support.v7.widget.Toolbar;                  //Libreria para usar la barra toolbar de arriba
import android.support.design.widget.TextInputLayout;     //libreria para usar los textInputLayout
import android.widget.Button;                             //Libreria para usar los botones
import android.view.View;                                 //Libreria para manejar eventos
